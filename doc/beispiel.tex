...
% pdf durch Ausgabeformat ersetzen: dvi, ps  oder pdf.
  \documentclass[ips,german,bachelorarbeit,pdf]{unitext}            % Default
% \documentclass[ips,german,bachelorarbeit,pdf,titelseite]{unitext} % Beispiel 1
% \documentclass[ips,german,bachelorarbeit,pdf,cd]{unitext}         % Beispiel 2
...
%%% Anhang
\bibliography{lit,prog} %%% obligatorisch
