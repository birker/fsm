...
public class UniversalTableCellRenderer extends JLabel implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (value instanceof Boolean) {
            ...
            if (ObjectInspector.ColorNames.containsKey(c)) {
                setText(ObjectInspector.ColorNames.get(c));
            } else {
